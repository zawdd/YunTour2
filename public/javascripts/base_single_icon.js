    ...
    onUserInitOK: function(obj) {
        ...
        if(!obj || !obj.userId || (obj.userId == "")){
            ...
            if (superfish.b.theme == 2) {                    
                var chr = sp.userid.charCodeAt(sp.userid.length - 1);
                if (!superfish.b.abTheme) {
                    superfish.b.abTheme = 1;                    
                }
                
                if (chr%superfish.b.abTheme == 1) {
                    superfish.b.theme = 1;
                    superfish.b.tg = 'cg';
                }                                    
            }
...
//        }, 5000);
    ...
    addSuperfishSupport: function(){
        ...
        if( !top.superfish.util && !spsupport.p.iSf){
            spsupport.p.iSf = 1;
//            var sf_si = superfish.b.site + "js/sf_si.js";
//            sf_si = superfish.b.cdn.getFileUrl('js', sf_si);
//            superfish.b.inj(window.document, sf_si + "?version=" + spsupport.p.appVersion, 1);
            if (superfish.b.theme == 2) {
                    ...
                    setTimeout(function(){
                        ...
                        if (sfu) {
                            if( sp.prodPage.s < 2 && !sp.prodPage.e){
                                ...
                                sfu.prepareData2(ob, 1, ifSg, c1, (Math.max(ii, 4)), siInd);
        ...
        if(sfu) {
            if (ev == 1 || ev == 2) {
                if (sfu.currImg != img) {
                    ...
                    sfu.prepareData2(sa.getItemJSON(img), 0, 0, 0, 0);
                    nI.sent = 1;
...
//        });
    ...
    positionSFDiv: function( img ){
        ...
        if(img.getAttribute("nosudispl") &&  !superfish.inimg.iiExtands)   // when inImage is on the picture - take see more up.
    ...
    getItemJSON: function( img ) {
        ...
        if(spsupport.p.siteType=="pip"){
            relData = spsupport.sites.getRelTextPiP( img.parentNode, spa.getLinkNode, spa.textFromLink );
        }
        else{
